...
def try_methods_and_functions():
    ...
    """
    ####################################################################
    # TdoneODO: 5. Implement this function, per its doc-string above.
    #    Put a statement in   main   to test this function
    #    (by calling this function).  IMPORTANT, IMPORTANT, IMPORTANT:
    #    Keep reading the rest of this TO DO before doing the above!
    #
    ...
    #
    ####################################################################
    dwight = rg.SimpleTurtle()
    dwight.pen = rg.Pen('blue', 5)

    dwight.backward(150)
    dwight.speed = 1
    draw_many_squares(dwight, 2, 100, 30)
    dwight.speed = 5
    dwight.pen = rg.Pen("red", 5)
    draw_many_squares(dwight, 10, 50, 15)
    dwight.speed = 100
    dwight.pen = rg.Pen("red", 35)
    draw_many_squares(dwight,8,300,60)
    dwight.NEWpen = rg.Pen("black", 3)
    dwight.backward(200)
    dwight.draw_circle(30)
    dwight.draw_square(50)
